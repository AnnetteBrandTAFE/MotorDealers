...
export default function DisplayDealer(props){
    return (
        <div style={{ border: '3px solid #3333ff', padding: '5px', margin: '5px'}}>
            ...
            <button onClick={()=>props.showUpdateDealerView(props.dealer)}>Edit</button> 
            <button onClick={()=>props.showUpdateDealerView(props.dealer)}>Delete</button> 
            </div>
)}